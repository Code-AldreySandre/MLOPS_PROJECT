...
def engineer_features(
        train_preprocessed: pd.DataFrame, test_preprocessed: pd.DataFrame) -> tuple[pd.DataFrame, pd.DataFrame, StandardScaler]:
    """Apply feature engineering transformatios.
    ...
    Returns: 
        tuple containing:
            pd.DataFrame: Engineering training features
            pd.DataFrame: Engineering test features
...
def save_artifacts(
    ...
    """Save engineering features and scaler.
